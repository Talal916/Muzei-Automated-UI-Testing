...
public class MuzeiActivityTest3 {

    @Rule
    public ActivityTestRule<MuzeiActivity> mActivityTestRule = new ActivityTestRule<>(MuzeiActivity.class);

    @Test
    public void muzeiActivityTest3() {
        ...
        ViewInteraction cardView = onView(
                allOf(childAtPosition(
                        allOf(withId(R.id.provider_list),
                                childAtPosition(
